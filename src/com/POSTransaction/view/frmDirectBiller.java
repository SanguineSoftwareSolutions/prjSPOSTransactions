    ...
    private void initComponents()
    {
        ...
        panelOperationButtonsLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelOperationButtonsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                ...
                .addComponent(btnPLU, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panelOperationButtonsLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnAgainstAdvOrder, btnCustomerHistory, btnDelBoy, btnHome, btnHomeDelivery, btnModifier, btnPLU, btnSettle, btnTakeAway});
        ...
        panelExternalCodeLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelExternalCodeLayout.createSequentialGroup()
                .addComponent(lblExtCode, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtExternalCode, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//                        Price: 0750
		...
		else
		{
		    ...
		    sql = "select count(strItemCode) from tblitemmaster where strExternalCode = '" + extCode + "'";
		    ResultSet rs = clsGlobalVarClass.dbMysql.executeResultSet(sql);
		    if (rs.next())
		    {
			int count = rs.getInt(1);
			...
			if (count > 0)
			{
			    String sql_ItemDtl = "SELECT strItemCode,strItemName,strStockInEnable,dblPurchaseRate "
				    + "FROM tblitemmaster WHERE strExternalCode = '" + extCode + "' ";
			    //System.out.println(sql_ItemDtl);
			    ResultSet rsItemInfo = clsGlobalVarClass.dbMysql.executeResultSet(sql_ItemDtl);
			    if (rsItemInfo.next())
			    {
